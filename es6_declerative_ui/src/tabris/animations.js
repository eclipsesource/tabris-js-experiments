...
export function fadeIn(duration = 400, delay = 0) {
	return fadeInConstructor({duration, delay});
}

export function fadeInRight(duration= 400, delay = 0, distance = 32) {
	return fadeInConstructor({duration, delay, translationX: distance});
}

export function fadeInLeft(duration = 400, delay = 0, distance = 32) {
	return fadeInConstructor({duration, delay, translationX: distance * (-1) });
}

export function fadeInDown(duration = 400, delay = 0, distance = 32) {
	return fadeInConstructor({duration, delay, translationY: distance});
}

export function fadeInUp(duration = 400, delay = 0, distance = 32) {
